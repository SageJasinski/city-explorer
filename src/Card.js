    ...
    return(
        ...
        <Card>
                <Card.Body>
                    ...
                    {this.props.weather.length > 0 && <Card.Text className="lat">Lat: {this.props.lat}</Card.Text>}

                   {this.props.weather.length > 0 && <Card.Text className="lon">Lon: {this.props.lon}</Card.Text>}
